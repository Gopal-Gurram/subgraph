...
import { Pair, Bundle, Token, qdexswapFactory, qdexswapDayData, PairDayData, TokenDayData } from '../types/schema'
...
export function updateqdexswapDayData(event: EthereumEvent): void {
  ...
  if (QdexswapDayData == null) {
    let QdexswapDayData = new qdexswapDayData(dayID.toString())
    QdexswapDayData.date = dayStartTimestamp
    QdexswapDayData.dailyVolumeUSD = ZERO_BD
    QdexswapDayData.dailyVolumeBNB = ZERO_BD
    QdexswapDayData.totalVolumeUSD = ZERO_BD
    QdexswapDayData.totalVolumeBNB = ZERO_BD
    QdexswapDayData.dailyVolumeUntracked = ZERO_BD
    QdexswapDayData.totalLiquidityUSD = ZERO_BD
    QdexswapDayData.totalLiquidityBNB = ZERO_BD
    QdexswapDayData.maxStored = maxTokenDayDatas
    QdexswapDayData.mostLiquidTokens = Qdexswap.mostLiquidTokens
    QdexswapDayData.txCount = ZERO_BI
    QdexswapDayData.save()
  }
  QdexswapDayData = qdexswapDayData.load(dayID.toString())
  QdexswapDayData.totalLiquidityUSD = Qdexswap.totalLiquidityUSD
  QdexswapDayData.totalLiquidityBNB = Qdexswap.totalLiquidityBNB
  QdexswapDayData.txCount = Qdexswap.txCount
  QdexswapDayData.save()
}
