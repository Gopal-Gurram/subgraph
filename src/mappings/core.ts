...
import { updatePairDayData, updateTokenDayData, updateqdexswapDayData, updatePairHourData } from './dayUpdates'
...
export function handleTransfer(event: Transfer): void {
  ...
  let factory = qdexswapFactory.load(FACTORY_ADDRESS)
...
export function handleSync(event: Sync): void {
  ...
  let Qdexswap = qdexswapFactory.load(FACTORY_ADDRESS)

  // reset factory liquidity by subtracting onluy tarcked liquidity
  Qdexswap.totalLiquidityBNB = Qdexswap.totalLiquidityBNB.minus(pair.trackedReserveBNB as BigDecimal)
  ...
  Qdexswap.totalLiquidityBNB = Qdexswap.totalLiquidityBNB.plus(trackedLiquidityBNB)
  Qdexswap.totalLiquidityUSD = Qdexswap.totalLiquidityBNB.times(bundle.bnbPrice)
...
export function handleMint(event: Mint): void {
  ...
  Qdexswap.txCount = Qdexswap.txCount.plus(ONE_BI)
...
export function handleSwap(event: Swap): void {
  ...
  let Qdexswap = qdexswapFactory.load(FACTORY_ADDRESS)
  Qdexswap.totalVolumeUSD = Qdexswap.totalVolumeUSD.plus(trackedAmountUSD)
  Qdexswap.totalVolumeBNB = Qdexswap.totalVolumeBNB.plus(trackedAmountBNB)
  Qdexswap.untrackedVolumeUSD = Qdexswap.untrackedVolumeUSD.plus(derivedAmountUSD)
  Qdexswap.txCount = Qdexswap.txCount.plus(ONE_BI)
  ...
  let QdexswapDayData = qdexswapDayData.load(dayID.toString())
  QdexswapDayData.dailyVolumeUSD = QdexswapDayData.dailyVolumeUSD.plus(trackedAmountUSD)
  QdexswapDayData.dailyVolumeBNB = QdexswapDayData.dailyVolumeBNB.plus(trackedAmountBNB)
  QdexswapDayData.dailyVolumeUntracked = QdexswapDayData.dailyVolumeUntracked.plus(derivedAmountUSD)
  QdexswapDayData.save()
