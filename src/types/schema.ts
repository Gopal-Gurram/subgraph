...
export class qdexswapFactory extends Entity {
  constructor(id: string) {
    ...
    this.set("mostLiquidTokens", Value.fromStringArray(new Array(0)));
  }

  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save qdexswapFactory entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save qdexswapFactory entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("qdexswapFactory", id.toString(), this);
    }
  }

  static load(id: string): qdexswapFactory | null {
    return changetype<qdexswapFactory | null>(store.get("qdexswapFactory", id));
  }
...
export class Token extends Entity {
  constructor(id: string) {
    ...
    this.set("mostLiquidPairs", Value.fromStringArray(new Array(0)));
  }
...
export class LiquidityPosition extends Entity {
  constructor(id: string) {
    ...
    this.set("historicalSnapshots", Value.fromStringArray(new Array(0)));
  }
...
export class BSCswapDayData extends Entity {
  constructor(id: string) {
    ...
    this.set("totalVolumeUSD", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("totalLiquidityUSD", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("maxStored", Value.fromI32(0));
    this.set("mostLiquidTokens", Value.fromStringArray(new Array(0)));
    this.set("txCount", Value.fromBigInt(BigInt.zero()));
  }
  ...
  static load(id: string): BSCswapDayData | null {
    return changetype<BSCswapDayData | null>(store.get("BSCswapDayData", id));
  }
